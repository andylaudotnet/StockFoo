 ...
 * description:
 *      
 * history : created by StockFoo 2010-05-25 16:47:44 
 */
        ...
        public string[] Fields {
            get {
                if (fields == null) {
                    lock (lockobj) {
                        if (fields == null) {
                            ICollection<string> fieldCollection = open.Reader.GetFieldNames(IndexReader.FieldOption.ALL);
